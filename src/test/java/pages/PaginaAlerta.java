...
public class PaginaAlerta {
	...
	public void hacerClickEnEspera() {
		btnEspera.click();
	}
	
	
	public void hacerClickEnAceptar(Alert alerta) {
		alerta.accept();
	}

	
	public void hacerClickEnCancelar() {
		btnCancelar.click();
	}
	
	public void hacerClickEnPrompt() {
		btnPrompt.click();
	}
	
	public void hacerClickEnCancelar(Alert alerta) {
		alerta.dismiss();
